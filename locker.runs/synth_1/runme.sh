...
HD_PWD='D:/vivadoproject/locker/locker.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log locker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source locker.tcl
