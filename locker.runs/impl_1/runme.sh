...
HD_PWD='D:/vivadoproject/locker/locker.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log locker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source locker.tcl -notrace
